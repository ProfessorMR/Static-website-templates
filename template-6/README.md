# Login / Register - Login and registration website

An example of a login and registration template.

## Screenshot

![Design preview for the login / register website](./images/desktop-preview.png)
